...
/**
 Base class for all _titaniumappApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the _titaniumappApp view hierarchy (such as wrapped iOS UIViews) was touched.
