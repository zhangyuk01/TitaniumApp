...
// in simulator we redefine to format for _titaniumappApp Developer console
...
{\
	NSString * exceptionName = [@"org.titaniumapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titaniumapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UI_titaniumappAppNativeItemNone = -1, 
	UI_titaniumappAppNativeItemSpinner = -2,
	UI_titaniumappAppNativeItemProgressBar = -3,
	
	UI_titaniumappAppNativeItemSlider = -4,
	UI_titaniumappAppNativeItemSwitch = -5,
	UI_titaniumappAppNativeItemMultiButton = -6,
	UI_titaniumappAppNativeItemSegmented = -7,
	
	UI_titaniumappAppNativeItemTextView = -8,
	UI_titaniumappAppNativeItemTextField = -9,
	UI_titaniumappAppNativeItemSearchBar = -10,
	
	UI_titaniumappAppNativeItemPicker = -11,
	UI_titaniumappAppNativeItemDatePicker = -12,
	
	UI_titaniumappAppNativeItemInfoLight = -13,
	UI_titaniumappAppNativeItemInfoDark = -14,
	
	UI_titaniumappAppNativeItemDisclosure = -15,
	
	UI_titaniumappAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all _titaniumappApp instances of
