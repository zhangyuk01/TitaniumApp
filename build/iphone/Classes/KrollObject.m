...
//@interface _titaniumappAppObject : NSObject
//@end

@interface _titaniumappAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[_titaniumappAppObject class]])
		{
			for (NSString *key in [[(_titaniumappAppObject*)o modules] allKeys])
			{
