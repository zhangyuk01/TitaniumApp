...
//Rare exceptions to indicate a bug in the _titaniumapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for _titaniumappApp proxies.
 */
