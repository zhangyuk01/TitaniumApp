...
@interface _titaniumappAppObject : KrollCoverageObject {
#else
@interface _titaniumappAppObject : KrollObject {
#endif
@private
...
extern NSString * _titaniumappApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	_titaniumappAppObject *_titaniumapp;
    KrollObject* console;
	BOOL shutdown;
